    ...
    AddEmployee(){
        ...
        add(tfage);
         ...
         bg.add(rbfemale);
               ...
               String str[] = { "Front Derk Clerks", "Porters", "Housekeeper","Kichen Staff","Chef","Room Service","Waiter/Waitress","Manager","Accountant","Security Guard","Directors","HR manager"};
